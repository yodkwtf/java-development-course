...
public class Game {
    ...
    public void begin(Team home, Team away) {
        System.out.println(
                "\n - This matchup takes place at the " + this.arena + " arena on " + this.date.format(
                        ...
                        "\n - The starting lineup for the visiting team is: at point guard, " + away
                                .getPlayer("POINT_GUARD")
